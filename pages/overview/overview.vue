<template>
	<view :class="isFix ? 'fixed' : ''">
		<AppletHeader :autoBack="false" @leftClick="handleClick" title="经营概况" left-icon="account" right-icon=" ">
		</AppletHeader>
		<view class="">
				...
				<view class="white mb20 echart">
					...
					<view class="tip">
						...
						<view class="tip-text">
							...
							<text @click="toggleCurrentDay(false)"
								:class="!currSeven ? 'active ml10' : 'ml10'">近30天</text>
						</view>
					</view>
